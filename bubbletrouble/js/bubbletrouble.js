...
var counter = 0;
	...
	var gameObject = {
		...
		// maxVelocity: cSizing * .5,
		// accelerationXUnit: cSizing * .008,
		// ftSizeConstant: cSizing * .14,
		...
		playerObj: function (x,y,width,height,color,iname1,file1,iname2,file2) {
			...
			this.tryToMove = function () {
				...
				var newVelX;
				var newVelY = 0;
				// var newVelY = (that.yVel > cSizing * .5) ? -that.yVel * .7 : 0 ;

				gameObject.collisionCheckArray.forEach(function(element){

					gameObject.checkCollisionBottom(that,element, newVelY);
					// square.fallFlag += that.checkCollisionTop(element);
					gameObject.checkCollisionRight(that, element);
					gameObject.checkCollisionLeft(that, element);
				}); 
		...
		checkCollisionRight: function (obj, other) {
			...
			if (
				...
				gameObject.resolveCollision(obj, other, 'right', 0);
			}	
		},// checkCollisionRight

		checkCollisionLeft: function (obj, other) {
			...
			if (
				...
				gameObject.resolveCollision(obj, other, 'left',0);
			}
		},// checkCollisionLeft
		...
		fire: function () {
			...
			this.tryToMove = function () {
				...
				// (gameObject.fallFlag === true) && gameObject.bounce(this);
				// (gameObject.fallFlag === true && gameObject.collisionRightFlag === true) && gameObject.fall(this);
				// (gameObject.movingLeftFlag  === true && gameObject.collisionLeftFlag  === false) && gameObject.moveLeft(this);
			}
	...
	var wall1 = new gameObject.backgroundObj (150,70,10,20,'brown');
	var square2 = new gameObject.backgroundObj (0,70,30,15,'red');
	var ground = new gameObject.backgroundObj (0,85,400,15,'brown');
